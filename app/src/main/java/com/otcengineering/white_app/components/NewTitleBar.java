...
public class NewTitleBar extends FrameLayout {
    ...
    public interface NewTitleBarListener {
        void onLeftClick();
    ...
    private NewTitleBarListener listener;
    ...
    public NewTitleBar(@NonNull Context context) {
        super(context);
    }

    public NewTitleBar(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void inflateView(Context context) {
        ...
        View view = inflater.inflate(R.layout.new_title_bar, this, true);
        retrieveViews(view);
        setEvents();
    }
    ...
    private void setEvents() {
        ...
        btnRight1.setOnClickListener(view -> {
            ...
            /*try {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("otc://covidhealp"));
    ...
    private final int mNecessaryClicks = 1;
    private Handler m_handler = new Handler();
    private Runnable m_runnable = () -> mClicks = 0;
    private void fun() {
        ++mClicks;
    ...
    public void setListener(NewTitleBarListener listener) {
