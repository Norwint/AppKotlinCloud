...
public class EcoItem implements Serializable {

    private LocalDate date;
    private double totalConsumption; //in liters
    private double averageConsumption; //in liters
    private String duration;
    private int globalRanking;
    private int localRanking;
    private List<Double> fragments;

    public EcoItem(String dateString, double totalConsumption, double averageConsumption, String duration,
                   int globalRanking, int localRanking, List<Double> fragments) {
